            ...
            <div class="card-body little-profile text-center">
                ...
                <div class="row text-center mt-2 mb-0">
                    ...
                    <p class="" style="color:rgb(255, 179, 128);">
                        ...
                        You made <?php echo $data['logged_in_user']->feel_better_count; ?> people feel better.
                    </div>
                    <?php endif ?>
                    </p>
                    <div class="col">
                        ...
                        <?php echo $data['logged_in_user']->feel_better_count; ?> people related to your participations.</p>
                        <?php endif ?>
                    </div>
                </div>
            </div>
